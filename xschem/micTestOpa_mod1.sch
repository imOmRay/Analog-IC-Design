...
N 50 -790 50 -780 {lab=vout}
N -40 -860 -10 -860 {lab=vcm}
N -40 -860 -40 -780 {lab=vcm}
N 50 -860 50 -790 {lab=vout}
N 40 -860 50 -860 {lab=vout}
N 40 -780 50 -780 {lab=vout}
N 410 -560 410 -550 {lab=GND}
N 40 -490 40 -460 {lab=GND}
N -40 -590 80 -590 {lab=vcm}
N -40 -660 -40 -590 {lab=vcm}
N -50 -660 -40 -660 {lab=vcm}
N 40 -660 80 -660 {lab=#net1}
N 40 -660 40 -550 {lab=#net1}
N 290 -620 410 -620 {lab=vout}
N 50 -780 320 -780 {lab=vout}
N 320 -780 320 -620 {lab=vout}
